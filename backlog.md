...
- **TICKET-015 (Session state manager)** – In Progress: per-session state/asset management for multi-stage back-and-forth, including remediation prompts for extra info.
