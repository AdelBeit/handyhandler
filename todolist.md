...
- **TICKET-008 (Discord remediation path)** – Todo: targeted “need more info” prompts and capture.
...
- **TICKET-013 (Confirmation image)** – In Progress: capture and send confirmation image after request is filed.
